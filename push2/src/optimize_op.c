...
/*   Updated: 2025/06/03 20:08:02 by jfernand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/push_swap.h"

static int	is_combinable(char *op1, char *op2)
{
...
static char	*get_combined_name(char *op1, char *op2)
{
...
static int	are_opposites(char *op1, char *op2)
{
...
static void	set_back_to_prev_or_head(t_op **cur, t_op *node, t_op_list *list)
{
	if (node)
		*cur = node;
	else
